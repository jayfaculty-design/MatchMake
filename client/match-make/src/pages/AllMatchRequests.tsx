...
import { BiBarChart, BiSearch, BiSolidCalendarAlt } from "react-icons/bi";
import { CiLocationOn } from "react-icons/ci";
import { MdCalendarMonth, MdSearchOff } from "react-icons/md";
  ...
  return (
    <div className="relative pt-20 flex h-auto min-h-screen w-full flex-col">
      <div className="flex flex-1">
        <aside className="sticky top-[68px] hidden h-[calc(100vh-68px)] w-72 flex-shrink-0 flex-col border-r border-gray-200/80 bg-background-light p-6 dark:border-white/10 dark:bg-background-dark lg:flex">
          <div className="flex flex-col gap-8">
            <div className="flex items-center gap-3">
              <span className="material-symbols-outlined text-2xl text-primary">
                <FiFilter className="text-primary bg-primary border-primary" />
              </span>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <input
                    className="h-10 w-full rounded-md border border-gray-200/80 bg-background-light pl-10 text-sm focus:border-primary focus:ring-primary dark:border-white/10 dark:bg-background-dark dark:placeholder:text-gray-500"
                    placeholder="Enter a city or address"
                    type="text"
                  />
                </div>
                <div className="relative flex w-full flex-col items-start justify-between gap-3 pt-2">
                  ...
                  <div className="flex h-4 w-full items-center">
                    <div className="flex h-1.5 flex-1 rounded-full bg-gray-200 dark:bg-white/10">
                      <div className="h-full w-[32%] rounded-full bg-primary"></div>
                      <div className="relative">
                        <div className="absolute -left-2 -top-1.5 size-4 rounded-full border-2 border-background-light bg-primary dark:border-background-dark"></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex cursor-pointer items-center gap-3">
                    <input
                      className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-gray-800 dark:ring-offset-background-dark"
                      name="skill-beginner"
                      type="checkbox"
                    />
          ...
          <div className="mt-auto flex flex-col gap-2 pt-8">
            ...
            <button className="flex h-10 w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-transparent px-4 text-sm font-bold text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/10">
              Reset
            </button>
          </div>
        </aside>
        <main className="w-full flex-1 p-6 lg:p-10">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 flex flex-col items-center justify-between gap-4 md:flex-row">
              <div className="flex w-full items-center gap-2 rounded-lg border border-gray-200/80 p-1 dark:border-white/10 md:w-auto">
              ...
              <div className="flex w-full flex-col-reverse gap-4 md:w-auto md:flex-row md:items-center">
                <div className="relative w-full md:max-w-xs">
                  ...
                  <input
                    className="h-12 w-full rounded-lg border border-gray-200/80 bg-background-light pl-12 text-sm focus:border-primary focus:ring-primary dark:border-white/10 dark:bg-background-dark dark:placeholder:text-gray-500"
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 xl:grid-cols-2">
              ...
              {!loading.getOpenedRequest && openedRequests.length === 0 && (
                <div className="col-span-1 flex min-h-[350px] flex-col items-center justify-center rounded-xl border border-dashed border-gray-300 bg-background-light p-6 text-center dark:border-white/20 dark:bg-gray-900/40 xl:col-span-2">
              ...
              {!loading.getOpenedRequest &&
                openedRequests.map((request: matchRequestProps) => (
                  <div className="flex flex-col rounded-xl border border-gray-200/80 bg-background-light p-6 transition-shadow hover:shadow-lg dark:border-white/10 dark:bg-gray-900/40 dark:hover:border-white/20">
                    <div className="flex items-start gap-4">
                      <img
                        className="h-14 w-14 flex-shrink-0 rounded-lg bg-gray-200 p-1 dark:bg-gray-700"
                        data-alt="team logo"
                    ...
                    <div className="mt-6 flex flex-col gap-4 border-t border-gray-200/80 pt-4 dark:border-white/10">
